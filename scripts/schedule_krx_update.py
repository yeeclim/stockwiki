...
from krx_full_data_updater import KRXDataUpdater
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('krx_scheduler.log'),
...
class KRXScheduler:
    ...
    def scheduled_update(self):
        ...
        try:
            ...
            success = self.updater.update_krx_data()
    ...
    def stop_scheduler(self):
        """스케줄러 중지"""
        self.is_running = False
        logging.info("⏹️ KRX 데이터 스케줄러 중지")
