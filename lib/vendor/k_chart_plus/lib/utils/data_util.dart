...
class DataUtil {
  static calculateAll(List<KLineEntity> dataList, List<MainIndicator> mainLi,
      List<SecondaryIndicator> secondaryLi) {
    calcVolumeMA(dataList);
    calculateIndicators(dataList, mainLi, secondaryLi);
  }

  static calculateIndicators(List<KLineEntity> dataList,
      List<MainIndicator> mainLi, List<SecondaryIndicator> secondaryLi) {
  ...
  static calculateIndicator(
      List<KLineEntity> dataList, IndicatorTemplate indicator) {
