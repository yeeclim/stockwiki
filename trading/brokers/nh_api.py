"""
NH투자증권 (나무) OpenAPI 래퍼
REST API: https://openapi.nhqv.com
"""
import os
import requests
...
class NHApi(BaseBrokerApi):
    def __init__(self, app_key=None, app_secret=None, account_no=None, acnt_code=None):
        self.app_key    = app_key    or os.environ['NH_APP_KEY']
        self.app_secret = app_secret or os.environ['NH_APP_SECRET']
        self.account_no = account_no or os.environ['NH_ACCOUNT_NO']
        self.acnt_code  = acnt_code  or os.environ.get('NH_ACCOUNT_PROD_CODE', '01')
        self.token      = None
