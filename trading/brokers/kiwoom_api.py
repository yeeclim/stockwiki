"""
키움증권 OpenAPI REST 래퍼
REST API: https://openapi.koreainvestment.com → 키움은 별도 도메인
실제 엔드포인트: https://openapi.kiwoom.com:9443
"""
import os
import requests
...
class KiwoomApi(BaseBrokerApi):
    def __init__(self, app_key=None, app_secret=None, account_no=None, acnt_code=None):
        self.app_key    = app_key    or os.environ['KIWOOM_APP_KEY']
        self.app_secret = app_secret or os.environ['KIWOOM_APP_SECRET']
        self.account_no = account_no or os.environ['KIWOOM_ACCOUNT_NO']
        self.acnt_code  = acnt_code  or os.environ.get('KIWOOM_ACCOUNT_PROD_CODE', '01')
        self.token      = None
